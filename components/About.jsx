...
function About() {
  return (
    <div className="w-[98%] border-slate-400 border-[2px] rounded-lg min-h-[50vh] bg-blue-200 border-solid">
      <p className="text-purple-700 text-3xl font-semibold text-center pt-[3%]">
        About Monkey Score
      </p>
      <p className="mx-[5%] text-xl mt-[3%] text-purple-500">
      ...
      <p className="mx-[5%] text-xl mt-[10px] text-purple-500">
